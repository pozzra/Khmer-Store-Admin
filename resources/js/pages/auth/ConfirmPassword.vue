...
const translations = {
    ...
    km: {
        confirmTitle: "បញ្ជាក់ពាក្យសម្ងាត់របស់អ្នក",
        confirmDesc: "នេះជាតំបន់សុវត្ថិភាព។ សូមបញ្ជាក់ពាក្យសម្ងាត់របស់អ្នកមុនពេលបន្ត។",
...
<template>
    <AuthLayout :title="t('confirmTitle')" :description="t('confirmDesc')">
